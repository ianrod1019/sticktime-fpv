...
export const SUPABASE_FUNCTIONS = {
  ...
  updateProfile: async (profileData: { display_name?: string; accent_color?: string; avatar_url?: string; tier?: string }) => {
  ...
  getSecurityLogs: async (options?: { limit?: number; eventType?: string; startDate?: string; endDate?: string }) => {
