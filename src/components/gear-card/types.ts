export const CONTROLLER_CATEGORIES = [
  ...
  { label: "Gimbals", value: "gimbals", placeholder: "e.g. AG01 Hall Gimbal" },
  {
    label: "Screen",
    value: "screen",
    placeholder: "e.g. OLED Replacement / Protector",
  },
  {
    label: "Switches",
    value: "switches",
    placeholder: "e.g. 3-Way Toggle Replacement",
  },
  {
    label: "Module / Bay",
    value: "module",
    placeholder: "e.g. ELRS Nano Backpack",
  },
  {
    label: "Battery",
    value: "battery",
    placeholder: "e.g. 21700 Li-Ion Pack Mod",
  },
] as const;
...
export const GOGGLES_CATEGORIES = [
  {
    ...
    value: "receiver",
    placeholder: "e.g. RapidFire, TBS Fusion, HDZero VTX",
  },
  {
    label: "Antenna Set",
    value: "antenna",
    placeholder: "e.g. TrueRC Patch & Match Set",
  },
  {
    label: "Faceplate / Foam",
    value: "foam",
    placeholder: "e.g. CNC Aluminum Faceplate / Silicone Foam",
  },
  {
    label: "Diopter Lenses",
    value: "diopter",
    placeholder: "e.g. -2.0 Prescription Insert",
  },
  {
    label: "Headstrap",
    value: "strap",
    placeholder: "e.g. Ethix Upgraded Elastic Band",
  },
  {
    label: "Battery Pack",
    value: "battery",
    placeholder: "e.g. 3000mAh Goggle Strap LiPo",
  },
] as const;
